...
public class PenSample3_2_SelectionSetting extends Activity {
    ...
    private ImageView mSelectionByPenBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSelectionByPenBtn = (ImageView) findViewById(R.id.selectionByPenBtn);
        mSelectionByPenBtn.setOnClickListener(mSelectionByPenBtnListener);
    ...
    private final OnClickListener mSelectionByPenBtnListener = new OnClickListener() {
        @Override
        public void onClick(View v) {
            if (android.os.Build.MODEL.toLowerCase().contains("n91")) {
                mSelectionByPenBtn.setSelected(!mSelectionByPenBtn.isSelected());
                mSpenSurfaceView.setPenButtonSelectionEnabled(mSelectionByPenBtn.isSelected());
                if (mSelectionByPenBtn.isSelected()) {
                    Toast.makeText(mContext, "Enable pen button selection.", Toast.LENGTH_LONG).show();
                } else {
                    Toast.makeText(mContext, "Disable pen button selection.", Toast.LENGTH_LONG).show();
                }
            } else {
                Toast.makeText(mContext, "Device not support this function.", Toast.LENGTH_LONG).show();
            }
        }
    };
